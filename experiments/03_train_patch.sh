...
#SBATCH --job-name=03-train-patch
...
#SBATCH --output=logs/03_train_patch_%j.log # %j is job id

user="janis.wehen"
condaenv="ba"
script_path="/dhc/home/janis.wehen/ba/models/bachelor-project/experiments"
log_path="/dhc/home/janis.wehen/ba/models/bachelor-project/experiments/logs/03_train_patch.log"
